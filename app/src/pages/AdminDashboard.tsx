      ...
      <div className="max-w-3xl mx-auto">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          ...
          <nav className="hidden md:flex items-center flex-nowrap gap-1 p-1 rounded-md border border-offwhite/20 bg-offwhite/5">
            ...
            <Link to="/admin/shows" className="inline-flex items-center gap-1.5 px-3 py-2 text-offwhite/80 hover:text-lime hover:bg-offwhite/10 rounded transition-colors text-sm whitespace-nowrap" title="Manage show pages">
              Shows pages
            </Link>
        ...
        {adminMenuOpen && (
          <div className="md:hidden mb-6 py-4 px-4 border border-offwhite/20 bg-offwhite/5 rounded">
            <nav className="flex flex-col gap-3">
              ...
              <Link to="/admin/shows" className="inline-flex items-center gap-2 text-offwhite hover:text-lime transition-colors text-sm py-2" onClick={() => setAdminMenuOpen(false)}>
                Shows pages
              </Link>
        ...
        {activeTab === 'gallery' && (
          <>
            ...
            <p className="text-offwhite/40 text-xs">Max 50MB per image. If uploads fail, ensure the backend is running and Cloudinary is configured on the server.</p>
