...
- **Reset admin password:** set `ADMIN_RESET_PASSWORD` to the new password in your env, redeploy/restart, then **remove** `ADMIN_RESET_PASSWORD` from env. The next startup will set the existing admin’s password to that value.
